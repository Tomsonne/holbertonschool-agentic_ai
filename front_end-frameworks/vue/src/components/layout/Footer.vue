<script setup>
import { Instagram, Music2, Twitter, Youtube } from "lucide-vue-next";
import Brand from "../ui/Brand.vue";
import SocialLink from "../ui/SocialLink.vue";
</script>

<template>
  <footer class="border-t border-slate-800 bg-black py-24 text-slate-500">
    <div class="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-[2fr_1fr_1fr_1fr]">
