        ...
        <section id="about-section" className="bg-black">
            <div className="max-w-6xl mx-auto px-6 flex flex-col items-center py-24 text-center">
                ...
                <p className="text-sm text-slate-300 md:text-base">
                    ...
                    and adapt their actions across multiple steps. Instead of only responding to a single prompt, an AI agent
                    can break down a task, plan a strategy, execute actions, evaluate results, and continue until the objective
                    is reached.
                </p>
                    ...
                    <div className="flex flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-950 p-8 text-start shadow-xl shadow-slate-950/40">
                        <div>
                            ...
                            <p className="mt-2 text-sm text-slate-500">
                                Responds to direct instructions, generates content, answers questions, or analyzes information
                                within a limited interaction.
                            </p>
                        </div>


                        <div aria-hidden="true" className="h-px w-full bg-slate-800" />
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-slate-500">
                                Understands a goal, chooses actions, uses external tools, follows a plan, and adjusts its
                    ...
                    <ol className="flex flex-col gap-6">
                        {steps.map((step) => (
                            <li key={step.number} className="relative flex flex-col items-start pl-12 text-start">
                                ...
                                <h3 className="mt-1 text-slate-50">
                                    {step.title}
                                </h3>
