...
function Features() {
    return (
        <section
            id="features-section"
            className="container mx-auto flex min-h-screen flex-col items-center justify-center px-4 py-24 text-center"
        >
            ...
            <div className="mt-12 grid w-full gap-8 md:grid-cols-3 lg:grid-cols-3">
